...
public class QuerySalesInvoice {
...
//		 Calling context - class CAdxCallContext 
       ...
       //XmlResult instance
		...
		System.out.println("Requested SINVOICE IS "+FLD_VALUE);
		 FileWriter fw = null;
		  PrintWriter pw = null;
		    fw = new FileWriter("C:\\WEBSERVICE\\SINVOICE\\QUERYWORD\\request.txt");
		...
		// MethoC: read(CAdxCallContext <context>, String <publicname>, CAdxParamKeyValue <key>) 
		try {
			System.out.println("Waitng for the response...");
			result = obj.query(cc, "SINVOICE", objKey,200);
			...
			StreamResult result2 = new StreamResult(new File("C:\\WEBSERVICE\\SINVOICE\\QUERYWORD\\response.xml"));
			transformer.transform(source, result2);
			System.out.println("Response XML saved at C:\\WEBSERVICE\\SINVOICE\\QUERYWORD");
			
			final String xmlFilePath = "C:\\WEBSERVICE\\SINVOICE\\QUERYWORD\\response.xml";
			try {
										...
										System.out.println(SN);
										 FileWriter fw1 = null;
										  PrintWriter pw1 = null;
										    fw1 = new FileWriter("C:\\WEBSERVICE\\SINVOICE\\QUERYWORD\\response.txt",true);
