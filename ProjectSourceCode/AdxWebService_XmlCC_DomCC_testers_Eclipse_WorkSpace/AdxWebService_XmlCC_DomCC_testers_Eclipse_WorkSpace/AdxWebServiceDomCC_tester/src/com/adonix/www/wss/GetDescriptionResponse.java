            ...
            */
            ...
            /**
            *  GetDescriptionResponse bean class
            */
        ...
        /* This type was generated from the piece of schema that had
            ...
            /**
            * field for GetDescriptionReturn
            */

            protected org.apache.axiom.om.OMElement localGetDescriptionReturn ;
           ...
           */
           public  org.apache.axiom.om.OMElement getGetDescriptionReturn(){
               return localGetDescriptionReturn;
           }
                   ...
                   * @param param GetDescriptionReturn
                   */
                   public void setGetDescriptionReturn(org.apache.axiom.om.OMElement param){
                    
                   this.localGetDescriptionReturn=param;
                   }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName){
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("",
                                    ...
                                    if (localGetDescriptionReturn==null){
                                         throw new RuntimeException("getDescriptionReturn cannot be null!!");
                                    }
                                    elementList.add(localGetDescriptionReturn);
    ...
    public static class Factory{
        ...
        */
        public static GetDescriptionResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetDescriptionResponse object = new GetDescriptionResponse();
            int event;
            try {
                ...
                while (!reader.isStartElement() && !reader.isEndElement())
                    ...
                    reader.next();
                            ...
                            if (reader.isStartElement() && new javax.xml.namespace.QName("","getDescriptionReturn").equals(reader.getName())){
                                     ...
                                     object.setGetDescriptionReturn(builder1.getOMElement());
