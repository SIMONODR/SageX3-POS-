...
public class CPrintfFormat
{
	 ...
	 * malformed.
	 */
	public CPrintfFormat(String fmtArg) throws IllegalArgumentException
	{
	 ...
	 * malformed.
	 */
	public CPrintfFormat(Locale locale, String fmtArg) throws IllegalArgumentException
	{
	...
	private class ConversionSpecification
	{
		...
		private char[] fFormatDigits(double x)
		{
			...
			{
				i = p + n1In - 1;
				if (i < ca3.length && (ca3[i] == '5' || ca3[i] == '6' || ca3[i] == '7' || ca3[i] == '8' || ca3[i] == '9'))
					carry = true;
				i--;
				for (; carry && i >= 0; i--)
				{
...
//				n2In = 0;
			...
			{
				if (ca1[i0 + p + 1] == '5' || ca1[i0 + p + 1] == '6' || ca1[i0 + p + 1] == '7' || ca1[i0 + p + 1] == '8' || ca1[i0 + p + 1] == '9')
					carry = true;
		...
		/** Default precision. */
		private final int defaultDigits = 6;
		/**
