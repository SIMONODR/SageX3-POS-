        ...
        /* This type was generated from the piece of schema that had
            ...
            /**
            * field for ModifyReturn
            */

            protected org.apache.axiom.om.OMElement localModifyReturn ;
           ...
           */
           public  org.apache.axiom.om.OMElement getModifyReturn(){
               return localModifyReturn;
           }
                   ...
                   * @param param ModifyReturn
                   */
                   public void setModifyReturn(org.apache.axiom.om.OMElement param){
                    
                   this.localModifyReturn=param;
                   }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName){
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("",
                                    ...
                                    if (localModifyReturn==null){
                                         throw new RuntimeException("modifyReturn cannot be null!!");
                                    }
                                    elementList.add(localModifyReturn);
    ...
    public static class Factory{
        ...
        */
        public static ModifyResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ModifyResponse object = new ModifyResponse();
            int event;
            try {
                ...
                while (!reader.isStartElement() && !reader.isEndElement())
                    ...
                    reader.next();
                            ...
                            if (reader.isStartElement() && new javax.xml.namespace.QName("","modifyReturn").equals(reader.getName())){
                                     ...
                                     object.setModifyReturn(builder1.getOMElement());
