            ...
            */
            ...
            /**
            *  RunResponse0 bean class
            */
        
        public  class RunResponse0
        implements org.apache.axis2.databinding.ADBBean{
            ...
            /**
            * field for RunResponse
            */

            protected com.adonix.www.wss.RunResponse localRunResponse ;
           
           

           /**
           * Auto generated getter method
           * @return com.adonix.www.wss.RunResponse
           */
           public  com.adonix.www.wss.RunResponse getRunResponse(){
               return localRunResponse;
                   ...
                   * @param param RunResponse
                   */
                   public void setRunResponse(com.adonix.www.wss.RunResponse param){
                    
                   this.localRunResponse=param;
                   }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName){
                ...
                //We can safely assume an element has only one type associated with it
                                ...
                                if (localRunResponse==null){
                                   return new org.apache.axis2.databinding.utils.reader.NullXMLStreamReader(MY_QNAME);
                                }else{
                                   return localRunResponse.getPullParser(MY_QNAME);
                                }
    ...
    public static class Factory{
        ...
        */
        public static RunResponse0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RunResponse0 object = new RunResponse0();
            int event;
            try {
                ...
                while (!reader.isStartElement() && !reader.isEndElement())
                    reader.next();
                            ...
                            if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.adonix.com/WSS","runResponse").equals(reader.getName())){
                            
                                    object.setRunResponse(com.adonix.www.wss.RunResponse.Factory.parse(reader));
