    ...
    public static class Factory{
        ...
        */
        public static ReadRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ReadRequest object = new ReadRequest();
            int event;
            try {
                ...
                while (!reader.isStartElement() && !reader.isEndElement())
                    ...
                    reader.next();
                            ...
                            if (reader.isStartElement() && new javax.xml.namespace.QName("","objectKeys").equals(reader.getName())){
                                     ...
                                     object.setObjectKeys(builder3.getOMElement());
