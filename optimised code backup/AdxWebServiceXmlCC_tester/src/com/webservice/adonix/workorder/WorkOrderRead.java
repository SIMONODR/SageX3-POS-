...
//			 Calling context - class CAdxCallContext 
			...
			String FLD_VALUE="DMM011201MFG00000011";
           ...
           //XmlResult instance
			...
			System.out.println("Requested SOHNUM IS "+FLD_VALUE);
			 FileWriter fw = null;
			  PrintWriter pw = null;
			    fw = new FileWriter("D:\\WEBSERVICE\\WREAD\\request.txt");
			...
			try {
				...
				result = obj.read(cc, "WORDER", objKey);
				...
				StreamResult result2 = new StreamResult(new File("D:\\WEBSERVICE\\WREAD\\response.xml"));
				transformer.transform(source, result2);
				System.out.println("Response XML saved at D:\\WEBSERVICE\\WREAD");
				
				final String xmlFilePath = "D:\\WEBSERVICE\\WREAD\\response.xml";
				try {
											...
											System.out.println(SN);
											 FileWriter fw1 = null;
											  PrintWriter pw1 = null;
											    fw1 = new FileWriter("D:\\WEBSERVICE\\WREAD\\response.txt");
