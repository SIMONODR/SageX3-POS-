        ...
        implements org.apache.axis2.databinding.ADBBean{
            ...
            /**
            * field for DeleteLines
            */

            protected com.adonix.www.wss.DeleteLinesRequest localDeleteLines ;
           
           

           /**
           * Auto generated getter method
           * @return com.adonix.www.wss.DeleteLinesRequest
           */
           public  com.adonix.www.wss.DeleteLinesRequest getDeleteLines(){
               return localDeleteLines;
           }
                   ...
                   * @param param DeleteLines
                   */
                   public void setDeleteLines(com.adonix.www.wss.DeleteLinesRequest param){
                    
                   this.localDeleteLines=param;
                   }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName){
                ...
                //We can safely assume an element has only one type associated with it
                                ...
                                if (localDeleteLines==null){
                                   return new org.apache.axis2.databinding.utils.reader.NullXMLStreamReader(MY_QNAME);
                                }else{
                                   return localDeleteLines.getPullParser(MY_QNAME);
                                }
    ...
    public static class Factory{
        ...
        */
        public static DeleteLines parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeleteLines object = new DeleteLines();
            int event;
            try {
                ...
                while (!reader.isStartElement() && !reader.isEndElement())
                    reader.next();
                            ...
                            if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.adonix.com/WSS","deleteLines").equals(reader.getName())){
                            
                                    object.setDeleteLines(com.adonix.www.wss.DeleteLinesRequest.Factory.parse(reader));
