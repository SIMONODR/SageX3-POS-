...
//			 Calling context - class CAdxCallContext 
           ...
           //XmlResult instance
			...
			System.out.println("Requested SOHNUM IS "+FLD_VALUE);
			 FileWriter fw = null;
			  PrintWriter pw = null;
			    fw = new FileWriter("C:\\WEBSERVICE\\QREAD\\request.txt");
			...
			try {
				...
				result = obj.query(cc, "SORDER", objKey,200);
				...
				StreamResult result2 = new StreamResult(new File("C:\\WEBSERVICE\\QREAD\\response.xml"));
				transformer.transform(source, result2);
				System.out.println("Response XML saved at C:\\WEBSERVICE\\QREAD");
				
				final String xmlFilePath = "C:\\WEBSERVICE\\QREAD\\response.xml";
				try {
											...
											System.out.println(SN);
											 FileWriter fw1 = null;
											  PrintWriter pw1 = null;
											    fw1 = new FileWriter("C:\\WEBSERVICE\\QREAD\\response.txt");
