...
//		 Calling context - class CAdxCallContext 
		...
		String FLD_NAME="NUM";
		String FLD_VALUE="ZAINV1501DMM01000141";
       ...
       //XmlResult instance
		...
		System.out.println("Requested SALES INVOIVE IS "+FLD_VALUE);
		 FileWriter fw = null;
		  PrintWriter pw = null;
		    fw = new FileWriter("C:\\WEBSERVICE\\SINVOICE\\request.txt");
	        pw = new PrintWriter(fw);
	        pw.write("Requested Work order number to the web service is..\n");
	        pw.write(FLD_VALUE);
	        pw.close();
	        fw.close();
		...
		try {
			...
			result = obj.read(cc, "SINVOICE", objKey);
			System.out.println(result.getResultXml());
			final String xmlStr =result.getResultXml();
			if(xmlStr==null)
			{
				System.out.println("Invalid Work Order number you are searching");
			}
			else
			...
			StreamResult result2 = new StreamResult(new File("C:\\WEBSERVICE\\SINVOICE\\response.xml"));
			transformer.transform(source, result2);
			System.out.println("Response XML saved at C:\\WEBSERVICE\\SINVOICE");
			
			final String xmlFilePath = "C:\\WEBSERVICE\\SINVOICE\\response.xml";
			try {
										...
										System.out.println(SN);
										 FileWriter fw1 = null;
										  PrintWriter pw1 = null;
										    fw1 = new FileWriter("C:\\WEBSERVICE\\SINVOICE\\response.txt");
									        pw1 = new PrintWriter(fw1);
									        pw1.write("Response \nWork order number from the web service number is..\n");
									        pw1.write(FLD_VALUE);
									        pw1.close();
									        fw1.close();
